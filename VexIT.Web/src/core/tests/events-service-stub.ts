...
export class EventsServiceStub {
  ...
  private static eventList = [{Name: 'Event1', Place: 'Place1', ScheduledAt: new Date()},
    {Name: 'Event2', Place: 'Place2', ScheduledAt: new Date()}];
  
  public static getItems(pageIndex?: number, pageSize?: number, orderBy?: string): Observable<PagedResult<EventDto>> {
